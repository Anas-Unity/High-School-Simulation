...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        // Load starting quest automatically
        QuestData startQuest = Resources.Load<QuestData>("Q_Rabbit_TalkToRabbit");
        if (startQuest != null)
            AddQuest(startQuest);
        else
            Debug.LogError("Quest 'Q_Rabbit_TalkToRabbit' not found in Resources/Quests/");
    }
